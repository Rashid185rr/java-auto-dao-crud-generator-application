...
public class Testing extends javax.swing.JFrame {
    ...
    public Testing(Table1[] table){
        setTableInTab(table);
        initComponents();

    }
     public void setTableInTab(Table1[] table){
     ...
     public List<String> getColumnList(Table1 table){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 20, 130, 54));
        ...
        columnList1 = new javax.swing.JList<>();
        ...
        tableTab1.add(insertChk1);
        insertChk1.setBounds(849, 320, 158, 42);

        jLabel2.setFont(new java.awt.Font("sansserif", 0, 36)); // NOI18N
        jLabel2.setText("Buttons");
        tableTab1.add(jLabel2);
        jLabel2.setBounds(819, 147, 364, 73);

        allBtnRD.setFont(new java.awt.Font("sansserif", 1, 24)); // NOI18N
        allBtnRD.setText("Select All");
        tableTab1.add(allBtnRD);
        allBtnRD.setBounds(819, 267, 138, 35);

        tableNameLBL1.setFont(new java.awt.Font("sansserif", 0, 36)); // NOI18N
        tableNameLBL1.setText("Table Name");
        tableTab1.add(tableNameLBL1);
        tableNameLBL1.setBounds(290, 6, 452, 111);
        tableTab1.add(columnSelectedLBL);
        columnSelectedLBL.setBounds(140, 219, 114, 47);

        columnList1.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N
        columnList1.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                columnList1ValueChanged(evt);
            }
        });
        scrollPane1.setViewportView(columnList1);

        tableTab1.add(scrollPane1);
        scrollPane1.setBounds(20, 92, 250, 416);
        ...
        tableTab1.add(deleteChk1);
        deleteChk1.setBounds(850, 360, 158, 42);
        ...
        tableTab1.add(updateChk1);
        updateChk1.setBounds(850, 410, 158, 42);
        tableTab1.add(columnSelectedLBL1);
        columnSelectedLBL1.setBounds(180, 520, 60, 47);
        ...
        tableTab1.add(viewChk1);
        viewChk1.setBounds(850, 450, 158, 42);
        ...
        tableTab1.add(cancelChk1);
        cancelChk1.setBounds(850, 490, 158, 42);
        ...
        tableTab1.add(backChk1);
        backChk1.setBounds(1010, 310, 158, 42);
        ...
        tableTab1.add(nextChk1);
        nextChk1.setBounds(1010, 360, 158, 42);
        ...
        columnsSelectionLBL1.setBounds(20, 520, 150, 47);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(prevTab, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(nextTab, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(503, 503, 503))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(prevTab, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nextTab)))
        );
    ...
    private void columnList1ValueChanged(javax.swing.event.ListSelectionEvent evt) {                                         
    ...
    private javax.swing.JList<String> columnList1;
